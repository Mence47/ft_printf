...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_print_he_capital.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: rtroll <marvin@42.fr>                      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/05 12:58:09 by rtroll            #+#    #+#             */
/*   Updated: 2019/01/15 20:16:15 by rtroll           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*ft_itoa_h(size_t n)
{
	char	*ptr;
	size_t	i;
	size_t	result;
...
int			ft_print_hex_capital(va_list ap, t_data data)
{
	...
	str = ft_change_format_h_capital(str, data);
	ft_putstr(str);
